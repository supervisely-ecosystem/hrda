...
if __name__ == '__main__':
    ...
    group.add_argument(
        '--config',
        default='configs/hrda/cracks_cfg.py',
    ...
    args = argparse.Namespace(config='configs/hrda/cracks_cfg.py', machine='local', exp=None, startup_test=False)
